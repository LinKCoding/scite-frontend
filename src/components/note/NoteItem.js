      ...
      return(
        <Grid >
          <Grid.Row>
            ...
            <Grid.Column width={5}>
              <PlainEditor noteID={this.props.currentNote.note.id} correctNote={this.props.correctNote}  noteContent={ convertedContent || this.props.currentNote.note.content} width={5} />
            </Grid.Column>
            <Grid.Column width={1}>
            </Grid.Column>
          </Grid.Row>
